...
parameter
                     ...
                     BAUTOTelectricity(t)
;
$call "gdxxrw Growth_Path.xlsx output=Growth_Path.gdx par=CFemissions rng=CFemissions!A1:AQ2 cdim=1 rdim=0  par=BAUemissions rng=BAUemissions!A1:AQ2 cdim=1 rdim=0  par=BAUGDP rng=BAUGDP!A1:AQ2 cdim=1 rdim=0 par=BAUTOTelectricity rng=BAUTOTelectricity!A1:AQ2 cdim=1 rdim=0";
...
Display  Energy1, TOT_Energy1, EM1, PLC1, ctr1, VAE1,
         F1, ENE1, FOSSIL1, SOLID1, NOS1, REF1, ELC1, X1, TX1, Z1,
         ADEEI1,
         HOHincome1, Xp1, Xg1, Xv1, E1, M1, Q1, D1,
         GDP1, GDPCHK1,
         C_AEEI1, C_TFP1, C_ELE1,
         Walras1, Walras21, FF1, RFF1,
         penebau1, pzbau1, pqbau1,  Xpbau1
